            ...
            <CardContent className="p-4">
              ...
              <div className="mt-4 pt-4 border-t border-border/50">
                ...
                {linkedInProfile ? (
                  ...
                  <div className="flex items-center gap-3">
                    <Avatar className="w-12 h-12 border-2 border-muted/50">
                      <AvatarFallback className="bg-muted/30 text-muted-foreground">
                        <User className="w-5 h-5" />
                      </AvatarFallback>
                    </Avatar>
                    <div className="flex-1 min-w-0">
                      <p className="font-medium text-muted-foreground">No profile synced</p>
                      <p className="text-sm text-muted-foreground">Connect extension & open LinkedIn to sync</p>
                    </div>
                  </div>
                )}
              </div>
